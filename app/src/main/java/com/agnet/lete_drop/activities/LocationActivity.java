...
import com.agnet.lete_drop.helpers.OrderStatusHelper;
...
public class LocationActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BottomSheetBehavior _bottomSheetBehavior = BottomSheetBehavior.from(bottomSheet);
        ...
        _bottomSheetBehavior.setPeekHeight(600);
        ...
        if (!preferences.getString("NEW_ORDER_NO", null).equals(null)) {
            ...
            int status = preferences.getInt("NEW_ORDER_STATUS", 0);

            TextView orderNoView = findViewById(R.id.order_no);
            orderNoView.setText(orderNo);

            Button orderStatus = findViewById(R.id.status_btn);

            orderStatusHelper.showButtonByStatus(orderStatus,status);
        ...
        callBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String phoneNo = preferences.getString("PHONE_NO", null);
        ...
        Button _cancelBtn = findViewById(R.id.cancel_order);
    ...
    // Create and customize the LocationComponent's options
            LocationComponentOptions customLocationComponentOptions = LocationComponentOptions.builder(this)
                  ...
                  //  .accuracyColor(Color.RED)
                    .foregroundDrawable(R.drawable.ic_add_black_24dp)
                    .build();
            ...
            findViewById(R.id.back_to_camera_tracking_mode).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (!isInTrackingMode) {
                        ...
                        Toast.makeText(LocationActivity.this, "Track has already been enabled",
    ...
    public void onLocationComponentClick() {
        if (locationComponent.getLastKnownLocation() != null) {
            Toast.makeText(this, String.format("my current location",
